...
public class FrequentTreatmentAdapters extends RecyclerView.Adapter<FrequentTreatmentAdapters.MyViewHolder>  {
    private List<Treatments> freqtreatmentList;
    ...
    public FrequentTreatmentAdapters(Context context, List<Treatments> freqtreatmentList) {
        this.mContext = context;
        this.freqtreatmentList = freqtreatmentList;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final Treatments list = freqtreatmentList.get(position);

        holder.freq_name.setText(list.getTreatmentName());

        holder.list_item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (listener != null)
                    listener.onItemClick(view, position,list.getTreatmentID(),list.getTreatmentName().toString(),list.getTreatmentDocID(),list.getTreatmentDocType(),list.getTreatmentFreqCount());
            }
        });
        ...
        holder.list_item.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                dialog1.setTitle("Frequent Treatment Information");
    ...
    public int getItemCount() {
        return freqtreatmentList.size();
    }

    public interface OnItemClickListener {
        void onItemClick(View itemView, int position, int examination_id, String examination_name, int freqDocID, int freqDocType, int freqCount);
    }
