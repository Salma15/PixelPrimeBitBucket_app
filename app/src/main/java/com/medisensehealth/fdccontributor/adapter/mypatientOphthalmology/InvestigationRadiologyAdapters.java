...
/**
 * Created by SALMA on 23-14-2019.
 */
public class InvestigationRadiologyAdapters extends RecyclerView.Adapter<InvestigationRadiologyAdapters.MyViewHolder>  {
    ...
    public InvestigationRadiologyAdapters(Context context, List<Investigations> testList) {
