...
/**
 * Created by SALMA on 23-04-2018.
 */
public class InvestigationClinicalAdapters extends RecyclerView.Adapter<InvestigationClinicalAdapters.MyViewHolder> {
    ...
    public InvestigationClinicalAdapters(Context context, List<Investigations> testList) {
