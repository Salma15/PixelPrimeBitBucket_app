...
public class DrugAllergyAdapters extends RecyclerView.Adapter<DrugAllergyAdapters.MyViewHolder> {

    private List<DrugAllery> alleryList;
    ...
    public DrugAllergyAdapters(Context context, List<DrugAllery> drugList) {
        this.mContext = context;
        this.alleryList = drugList;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final DrugAllery list = alleryList.get(position);
        ...
        holder.name.setText(list.getGenericName());
        ...
        holder.list_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog1.setTitle("Drug Allergy Information");
                dialog1.setMessage("Generic Name: " + list.getGenericName().toString() +"\n\nGeneric ID: "+ list.getGenericId());
        ...
        holder.delete_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTitle("Remove Drug Allergy?");
                dialog.setMessage("Do you want to remove from Drug Allergy list?");
    ...
    public void onItemDismiss(int position) {
        if (position != -1 && position < alleryList.size()) {
            alleryList.remove(position);
