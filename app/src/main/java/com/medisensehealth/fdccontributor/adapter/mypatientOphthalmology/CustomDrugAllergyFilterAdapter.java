...
public class CustomDrugAllergyFilterAdapter  extends ArrayAdapter<DrugAllery> {

    Context mContext;
    private List<DrugAllery> animalNamesList = null;
    private ArrayList<DrugAllery> arraylist;
    LayoutInflater inflater;

    public CustomDrugAllergyFilterAdapter(Context context, int resourceId,
                                           List<DrugAllery> items) {
        super(context, resourceId, items);
        this.mContext = context;
        this.animalNamesList = items;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<DrugAllery>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent)    {
        ...
        DrugAllery rowItem = getItem(position);
        ...
        holder.m_title.setText(rowItem.getGenericName());
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (DrugAllery wp : arraylist) {
                if (wp.getGenericName().toLowerCase(Locale.getDefault()).contains(charText)) {
