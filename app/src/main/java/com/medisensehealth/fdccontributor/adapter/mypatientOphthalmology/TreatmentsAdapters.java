...
public class TreatmentsAdapters extends RecyclerView.Adapter<TreatmentsAdapters.MyViewHolder> {
    ...
    public TreatmentsAdapters(Context context, List<Treatments> treatmentList) {
