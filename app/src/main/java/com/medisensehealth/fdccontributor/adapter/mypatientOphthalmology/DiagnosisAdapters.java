...
public class DiagnosisAdapters extends RecyclerView.Adapter<DiagnosisAdapters.MyViewHolder> {
    ...
    public DiagnosisAdapters(Context context, List<Diagnosis> diagnosisList) {
