...
public class SearchSendCaseDoctorsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( b != null) {
            ...
            Log.d(Utils.TAG, "********* Send case Search**************");
        ...
        shareadPreferenceClass = new ShareadPreferenceClass(SearchSendCaseDoctorsActivity.this);
        sharedPreferences = shareadPreferenceClass.getSharedPreferences(SearchSendCaseDoctorsActivity.this);
        ...
        Log.d(Utils.TAG , " *********** Search SendCase Doctors ****************");
    ...
    private void initializationViews() {
        ...
        adapter = new SendCaseAdapter(this,doctorListArraylist, PATIENT_ID, DOCREF_ID);
        ...
        doctorListArraylist = MedisensePracticeDB.getAllDoctors(this, USER_LOGIN_TYPE,USER_ID);
        ...
        final DoctorsSeachAdapter adapter = new DoctorsSeachAdapter(this, R.layout.fragment_doctors, R.id.lbl_name, doctorListArraylist);
    ...
    private void collectDoctorsSearchResultFromServer(final String SEARCH_QUERY) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(SearchSendCaseDoctorsActivity.this, ProgressDialog.THEME_HOLO_LIGHT);
                                ...
                                if (staus_res.equals("false")) {
                                    ...
                                    try {
                                        ...
                                        if (jsonArray.length() > 0) {
                                            Log.d(Utils.TAG, " size: "+ jsonArray.length());
                                            ...
                                            adapter = new SendCaseAdapter(SearchSendCaseDoctorsActivity.this, doctorListArraylist,PATIENT_ID, DOCREF_ID);
                                            recyclerView_doctorlist.setAdapter(adapter);
                                            adapter.notifyDataSetChanged();
                                        }
        ...
        RequestQueue requestQueue = AppController.getInstance(SearchSendCaseDoctorsActivity.this).
                getRequestQueue();
        AppController.getInstance(SearchSendCaseDoctorsActivity.this).addToRequestQueue(stringRequest);
    }
}
