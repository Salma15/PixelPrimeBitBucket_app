...
public class VideoDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String DOWNLOAD_BLOG_IMAGE_URL, BLOG_CONTACTINFO, BLOG_ATTACHMENTS, BLOG_TRANSACTIONID, BLOG_NUM_VIEWS, BLOG_VIDEO_URL;
    ...
    String BLOG_VIDEO_ID;

    CustomTextView title, blog_like_count, blog_comment_count, surgical_numviews, surgical_username, surgical_postdate;
    ImageView blog_like, blog_Comment,  send_email,  share_facebook, share_twitter, share_whatsapp, share_googleplus, share_linkedin;
    CustomEditText write_comments, _edt_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( bundle != null) {
            ...
            BLOG_VIDEO_URL = bundle.getString("BLOG_VIDEO_URL", "");

            Log.d(Utils.TAG , "******************* Surgical Details *************");
        ...
        shareadPreferenceClass = new ShareadPreferenceClass(VideoDetailActivity.this);
        sharedPreferences = shareadPreferenceClass.getSharedPreferences(VideoDetailActivity.this);
    ...
    private void initializationViews() {
        ...
        playButton=(ImageView) findViewById(R.id.surgical_btnYoutube_player);
        playButton.setOnClickListener(this);
        relativeLayoutOverYouTubeThumbnailView = (RelativeLayout) findViewById(R.id.surgical_relativeLayout_over_youtube_thumbnail);
        youTubeThumbnailView = (YouTubeThumbnailView) findViewById(R.id.surgical_youtube_thumbnail);

        title = (CustomTextView) findViewById(R.id.surgicaldetail_title);
        blog_like = (ImageView) findViewById(R.id.surgicaldetail_like);
        blog_like.setOnClickListener(this);
        blog_Comment = (ImageView) findViewById(R.id.surgicaldetail_comment);
        blog_Comment.setOnClickListener(this);
        blog_like_count = (CustomTextView) findViewById(R.id.surgicaldetail_like_count);
        blog_comment_count = (CustomTextView) findViewById(R.id.surgicaldetail_comment_count);
        comment_layout = (LinearLayout) findViewById(R.id.surgicaldetail_comment_layout);
        comment_layout.setVisibility(View.GONE);
        write_comments = (CustomEditText) findViewById(R.id.surgicaldetail_write_comment);
        comment_send = (ImageView) findViewById(R.id.surgicaldetail_send_comment);
        comment_send.setOnClickListener(this);
        _edt_email = (CustomEditText) findViewById(R.id.surgicaldetail_email);
        send_email = (ImageView) findViewById(R.id.surgicaldetail_send_email);
        send_email.setOnClickListener(this);

        surgical_numviews = (CustomTextView) findViewById(R.id.surgicaldetail_views);
        surgical_username = (CustomTextView) findViewById(R.id.surgicaldetail_userName);
        surgical_postdate = (CustomTextView) findViewById(R.id.surgicaldetail_postedon);

        share_facebook = (ImageView) findViewById(R.id.surgicaldetail_facebook);
        share_twitter = (ImageView) findViewById(R.id.surgicaldetail_twitter);
        share_whatsapp = (ImageView) findViewById(R.id.surgicaldetail_whatsapp);
        share_linkedin = (ImageView) findViewById(R.id.surgicaldetail_linkedin);
        ...
        userProfile_image = (ImageView) findViewById(R.id.surgicaldetail_userprofileImg);
        ...
        if(BLOG_USERIMAGE.equals("")) {
            ...
            Picasso.with(VideoDetailActivity.this).load(String.valueOf(url_pof))
        ...
        surgical_numviews.setText("Views: "+BLOG_NUM_VIEWS);
        surgical_username.setText(BLOG_USERNAME);
        ...
        if(BLOG_DATE.equals("")) {
            ...
            try {
                ...
                surgical_postdate.setText(post_date);
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }

        recyclerView = (RecyclerView)findViewById(R.id.surgicaldetail_recyclerview);

        mAdapter = new CommentsAdapter(VideoDetailActivity.this, commentList);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(VideoDetailActivity.this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mAdapter);

        String[] parts = BLOG_VIDEO_URL.split("/");
        BLOG_VIDEO_ID = parts[parts.length - 1];
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.surgical_btnYoutube_player:

                if(YouTubeApiServiceUtil.isYouTubeApiServiceAvailable(VideoDetailActivity.this).equals(YouTubeInitializationResult.SUCCESS)){
                    //This means that your device has the Youtube API Service (the app) and you are safe to launch it.
                    Intent intent = YouTubeStandalonePlayer.createVideoIntent(VideoDetailActivity.this, YOUTUBE_API_KEY, BLOG_VIDEO_ID);
                    startActivity(intent);
                }else{
                    // Log the outcome, take necessary measure, like playing the video in webview :)
                    Toast.makeText(VideoDetailActivity.this, "Youtube Application is not found !!!", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.surgicaldetail_like:
                String EVENT_TYPE = "1";
                ...
                break;
            case R.id.surgicaldetail_comment:
                ...
                break;
            case R.id.surgicaldetail_send_comment:
                if(write_comments.getText().toString().equals("")) {
                    Toast.makeText(VideoDetailActivity.this, "Please write comments !!!", Toast.LENGTH_SHORT).show();
                }
                else {
                    sendSurgicalCommmentLink(write_comments.getText().toString());
                }
                break;
            case R.id.surgicaldetail_send_email:
                if(_edt_email.getText().toString().trim().equals("")) {
                    Toast.makeText(VideoDetailActivity.this, "Please enter email address", Toast.LENGTH_SHORT).show();
                }
                else {
                    sendSurgicalEmailLink(_edt_email.getText().toString());
                }
                break;
            case R.id.surgicaldetail_facebook:
                shareViaFacebookLink();
                break;
            case R.id.surgicaldetail_twitter:
                shareViaTwiterLink();
                break;
            case R.id.surgicaldetail_whatsapp:
                shareViaWhatsAppLink();
                break;
            case R.id.surgicaldetail_linkedin:
    ...
    private void viewAllComments(List<Comments> commentList) {
        final Dialog dialogViewCard = new Dialog(VideoDetailActivity.this);
        ...
        send_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(_edt_comment_msg.getText().toString().equals("")) {
                    ...
                    sendSurgicalCommmentLink(_edt_comment_msg.getText().toString());
                }
            }
        });
    }
    ...
    private void shareViaWhatsAppLink() {
        ...
        try {
            ...
            Toast.makeText(VideoDetailActivity.this, "Whatsapp have not been installed", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void shareViaLinkedinLink() {
        ...
        if(resolved){
            ...
            Toast.makeText(VideoDetailActivity.this, "Linkedin app isn't found", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void shareViaTwiterLink() {
        ...
        if(resolved){
            ...
            Toast.makeText(VideoDetailActivity.this, "Twitter app isn't found", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void shareViaFacebookLink() {
        ...
        if(resolved){
            ...
            Toast.makeText(VideoDetailActivity.this, "Facebook app isn't found", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void setRequestToServer() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIClass.DRS_FEEDS_LIKE_COMMENT_COUNT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.d(Utils.TAG," surgical likes: "+ response.toString());
                        if (response != null) {
                            // String success;
        ...
        RequestQueue requestQueue = AppController.getInstance(VideoDetailActivity.this).
                getRequestQueue();
        AppController.getInstance(VideoDetailActivity.this).addToRequestQueue(stringRequest);
    }

    private void sendSurgicalEmailLink(final String email_address) {
        Log.d(Utils.TAG, "email: "+email_address);
        Log.d(Utils.TAG, "trans: "+BLOG_TRANSACTIONID);
        Log.d(Utils.TAG, "type: "+BLOG_TYPE);

        final ProgressDialog progressDialog = new ProgressDialog(VideoDetailActivity.this, ProgressDialog.THEME_HOLO_LIGHT);
                        ...
                        if (response != null) {
                            ...
                            try {
                                ...
                                if(staus_res.equalsIgnoreCase("success")) {
                                    Toast.makeText(VideoDetailActivity.this, "Email sent successfully.", Toast.LENGTH_SHORT).show();
                                    _edt_email.setText("");
                                }
                                else   if(staus_res.equalsIgnoreCase("failure")) {
                                    Toast.makeText(VideoDetailActivity.this, "Failed to send an email.", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
    ...
    private void sendSurgicalCommmentLink(final String comment_text) {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null) {
                            ...
                            try {
                                ...
                                if(staus_res.equalsIgnoreCase("success")) {
                                    Toast.makeText(VideoDetailActivity.this, "Comments added successfully.", Toast.LENGTH_SHORT).show();
                                    write_comments.setText("");
                                    setRequestToServer();
                                }
                                else   if(staus_res.equalsIgnoreCase("failure")) {
                                    Toast.makeText(VideoDetailActivity.this, "Failed to add comment.", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
